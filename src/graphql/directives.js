...
var IsAuthenticated = /** @class */ (function (_super) {
    __extends(IsAuthenticated, _super);
    ...
    // }
    IsAuthenticated.prototype.visitFieldDefinition = function (field) {
...
exports.DirectivesModule = new core_1.GraphQLModule({
    ...
    contextBuilder: function (_a, currentContext) {
        var req = _a.req;
        return __awaiter(_this, void 0, void 0, function () {
            var authorization, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        authorization = req.headers.authorization;
                        _b = {};
                        return [4 /*yield*/, auth_1.checkAuth(authorization)["catch"](logger_1.logCath)];
                    case 1: return [2 /*return*/, (_b.currentUser = _c.sent(),
                            _b)];
                }
            });
        });
