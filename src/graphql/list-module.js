...
var listItem_module_1 = require("./listItem-module");
...
exports.ListModule = new core_1.GraphQLModule({
    ...
    resolvers: {
        List: {
            items: function (_a, args, context) {
                var id = _a.id;
                return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_b) {
                        return [2 /*return*/, listItem_1.getListItem(id)];
                    });
                });
            }
        },
        Query: {
            list: function (_, _a, context) {
                var id = _a.id;
                return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_b) {
        ...
        Mutation: {
            listCreate: function (_, _a, context) {
                var input = _a.input, id = _a.id;
                return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_b) {
                        return [2 /*return*/, list_1.createList(input, id)];
                    });
                });
            },
            listUpdate: function (_, _a, context) {
                var input = _a.input, id = _a.id;
                return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_b) {
                        return [2 /*return*/, list_1.updateList(id, input)];
                    });
                });
            },
            listDelete: function (_, _a, context) {
                var id = _a.id;
                return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_b) {
                        return [2 /*return*/, list_1.deleteList(id)];
                    });
                });
            }
        }
